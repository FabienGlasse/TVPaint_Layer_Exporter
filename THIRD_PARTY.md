...
The installer obtains Python from [python.org](https://www.python.org/) when needed and installs the Python packages listed in [requirements.txt](portable_exporter/requirements.txt) from PyPI. These components retain their own licenses.
